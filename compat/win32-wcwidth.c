/*
 * win32-wcwidth.c - wcwidth() for Windows
 *
 * Derived from Markus Kuhn's public domain wcwidth implementation:
 *   https://www.cl.cam.ac.uk/~mgk25/ucs/wcwidth.c
 *
 * This is the mk_wcwidth() logic adapted for use as wcwidth() on Windows,
 * where the C runtime does not provide a conforming implementation.
 *
 * Returns:
 *   -1  for non-printable control characters
 *    0  for combining (zero-width) characters
 *    1  for normal characters
 *    2  for double-width (CJK, fullwidth) characters
 *
...
/* Test whether |ucs| falls in any of the sorted |table| intervals. */
static int
bisearch(unsigned int ucs, const struct interval *table, int max)
{
    int min = 0;
    int mid;
...
/*
 * Zero-width combining characters (Unicode 15.0).
 * These are characters with General_Category=Mn, Me, or Cf,
 * plus a selection of Cs (surrogates, treated as non-printable here).
 */
static const struct interval combining[] = {
    ...
    { 0x07FD, 0x07FD }, { 0x0816, 0x0823 }, { 0x0825, 0x082D },
    { 0x0859, 0x085B }, { 0x0898, 0x089F }, { 0x08CA, 0x0902 },
...
/*
 * Double-width characters (Unicode 15.0).
 * Ranges of East_Asian_Width=W or F.
 */
static const struct interval wide[] = {
    ...
    { 0x26CE, 0x26CF }, { 0x26D4, 0x26D4 }, { 0x26EA, 0x26EA },
    ...
    { 0x2B55, 0x2B55 }, { 0x2E80, 0x303E }, { 0x3041, 0x33BF },
    { 0x33FF, 0xA4CF }, { 0xA960, 0xA97F }, { 0xAC00, 0xD7FF },
    { 0xF900, 0xFAFF }, { 0xFE10, 0xFE19 }, { 0xFE30, 0xFE6F },
    { 0xFF01, 0xFF60 }, { 0xFFE0, 0xFFE6 },
    { 0x16FE0, 0x16FE4 }, { 0x16FF0, 0x16FF1 },
    { 0x17000, 0x187FF }, { 0x18800, 0x18CFF }, { 0x18D00, 0x18D7F },
    { 0x1AFF0, 0x1B16F }, { 0x1B170, 0x1B2FF }, { 0x1F004, 0x1F004 },
    { 0x1F0CF, 0x1F0CF }, { 0x1F18E, 0x1F18E }, { 0x1F191, 0x1F19A },
    { 0x1F1E0, 0x1F1FF }, { 0x1F201, 0x1F202 }, { 0x1F21A, 0x1F21A },
    ...
    { 0x1FA00, 0x1FA6F }, { 0x1FA70, 0x1FA7C }, { 0x1FA80, 0x1FA88 },
...
wcwidth(wchar_t wc)
{
    unsigned int ucs = (unsigned int)wc;
    ...
    if (bisearch(ucs, wide,
            (int)(sizeof wide / sizeof wide[0]) - 1))
        return 2;
